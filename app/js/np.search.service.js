...
SearchService.factory('Search',[
  ...
  function($resource, $http, $cookies, $cookieStore, config){
	...
	Search.prototype.docs=function(params,cb){
		...
		// $http.defaults.headers.common['Referer'] = 'http://localhost:3000';
		console.log('this.params: ', this.params, ' payload: ', params);

		$api.search(this.params, params).$promise.then(function(docs) {
